-- ================================================================
-- Fase 2: Schema — colunas novas em tabelas existentes + tabelas novas
-- Sem alterar dados históricos de XP.
-- ================================================================

-- 2.1 Streak freeze em gamificacao_perfis
...
-- 2.2 Raridade + metas em conquistas (substitui META_POR_CODIGO do frontend)
...
-- 2.5 Feature flag para gamificação de clube
INSERT INTO app_settings (key, value)
VALUES ('show_gamificacao_clube', 'false')
ON CONFLICT (key) DO NOTHING;

-- 2.6 Atualiza conceder_xp para incluir lógica de streak freeze
--     e atualizar clube_temporadas_ranking + clube_gamificacao
...
BEGIN
  ...
  -- Lê estado atual do streak para calcular novo valor
  ...
  -- Se contexto de clube: atualiza ranking semanal e XP do clube
  IF p_clube_id IS NOT NULL THEN
...
-- 2.7 trg_gamificacao_streak concede freezes nos marcos de consistência
...
BEGIN
  ...
  -- Concede 1 freeze ao atingir marcos de streak
